...
-- ------------------------------------------------------------
-- Loyalty prerequisites required by chat XP
-- ------------------------------------------------------------
...
alter table public.loyalty_accounts add column if not exists lifetime_xp bigint not null default 0;
alter table public.loyalty_accounts add column if not exists supply_credits integer not null default 0;
alter table public.loyalty_accounts add column if not exists consecutive_paid_months integer not null default 0;
alter table public.loyalty_accounts add column if not exists xp_multiplier numeric(4,2) not null default 1.00;
alter table public.loyalty_accounts add column if not exists updated_at timestamptz not null default now();
